Aqui está a versão do seu documento formatada em Markdown, pronta para você copiar e colar em um arquivo (como `exercicios.md` ou `README.md`) no seu repositório do GitHub:
